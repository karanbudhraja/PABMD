...
aData = np.delete(processedData, [0], axis=1)
np.savetxt("../../../data/domaindata/processed_" + "forward_kinematics_b" + ".txt", aData, fmt="%s", header="i"*INDEPENDENT_VARIABLES+"d"*DEPENDENT_VARIABLES, comments="")
...
aData = np.delete(scaleData, [0], axis=1)
with open("scale_data_forward_kinematics_b.txt", "w") as outFile:
